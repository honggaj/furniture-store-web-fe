...
export function apiUserPost$Json(http: HttpClient, rootUrl: string, params?: ApiUserPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<UserResponse>> {
